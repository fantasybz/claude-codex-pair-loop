...
```bash
./skills/codex-first-pair-loop/scripts/run-pair-loop.sh --profile deep --claude-model sonnet --codex-model gpt-5.3-codex --codex-effort xhigh --task "Continue the current project"
```
