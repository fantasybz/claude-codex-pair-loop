...
```bash
./skills/codex-first-pair-loop/scripts/run-pair-loop.sh --session-name hardening-pass --validation-preset pytest --until-tests-pass --task "Continue the current project"
```
